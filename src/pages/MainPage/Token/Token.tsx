    ...
    <div className="token" id="token">
      ...
      <div className="token-info">
        <svg width="446" height="446" viewBox="0 0 446 446" fill="none" xmlns="http://www.w3.org/2000/svg">
          <circle
            className="circle1" cx="222.851" cy="222.851" r="222.265" stroke="url(#paint0_linear_8_472)"
            strokeWidth="1.1729" />
          <circle
            className="circle2" cx="222.265" cy="222.265" r="195.875" stroke="url(#paint1_linear_8_472)"
            strokeWidth="1.1729" />
          <path
          ...
          <path
            ...
            stroke="url(#paint7_linear_8_472)" strokeWidth="0.92642" strokeLinecap="round" />
          <defs>
            <linearGradient
              id="paint0_linear_8_472" x1="222.852" y1="445.703" x2="222.852" y2="0"
              gradientUnits="userSpaceOnUse">
              <stop stopColor="white" />
              <stop offset="1" stopColor="white" stopOpacity="0" />
            </linearGradient>
            <linearGradient
              id="paint1_linear_8_472" x1="222.265" y1="25.804" x2="222.265" y2="418.726"
              gradientUnits="userSpaceOnUse">
              <stop stopColor="white" />
              <stop offset="1" stopColor="white" stopOpacity="0" />
            </linearGradient>
            <linearGradient
              id="paint2_linear_8_472" x1="214.673" y1="238.352" x2="192.89" y2="312.518"
              gradientUnits="userSpaceOnUse">
              <stop stopColor="white" />
              <stop offset="1" stopColor="white" stopOpacity="0" />
            </linearGradient>
            <linearGradient
              id="paint3_linear_8_472" x1="182.88" y1="200.451" x2="160.933" y2="275.173"
              gradientUnits="userSpaceOnUse">
              <stop stopColor="white" />
              <stop offset="1" stopColor="white" stopOpacity="0" />
            </linearGradient>
            <linearGradient
              id="paint4_linear_8_472" x1="262.13" y1="223.594" x2="240.148" y2="298.438"
              gradientUnits="userSpaceOnUse">
              <stop stopColor="white" />
              <stop offset="1" stopColor="white" stopOpacity="0" />
            </linearGradient>
            <linearGradient
              id="paint5_linear_8_472" x1="212.258" y1="100.428" x2="183.508" y2="198.313"
              gradientUnits="userSpaceOnUse">
              <stop stopColor="white" />
              <stop offset="1" stopColor="white" stopOpacity="0" />
            </linearGradient>
            <linearGradient
              id="paint6_linear_8_472" x1="291.471" y1="123.694" x2="262.722" y2="221.579"
              gradientUnits="userSpaceOnUse">
              <stop stopColor="white" />
              <stop offset="1" stopColor="white" stopOpacity="0" />
            </linearGradient>
            <linearGradient
              id="paint7_linear_8_472" x1="237.248" y1="161.494" x2="215.464" y2="235.66"
              gradientUnits="userSpaceOnUse">
              <stop stopColor="white" />
              <stop offset="1" stopColor="white" stopOpacity="0" />
            </linearGradient>
