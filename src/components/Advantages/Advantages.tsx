            ...
            <div className="big-planet">
                <svg width="672" height="372" viewBox="0 0 672 372" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path
                        ...
                        fill="url(#paint0_linear_8_555)" stroke="url(#paint1_linear_8_555)" stroke-width="0.720133"/>
                    <path
                        ...
                        stroke="url(#paint2_linear_8_555)" stroke-width="0.720133"/>
                    <path
                        ...
                        stroke="url(#paint3_linear_8_555)" stroke-width="0.720133"/>
                    <path
                        ...
                        stroke="url(#paint4_linear_8_555)" stroke-width="0.720133"/>
                    <defs>
                        <linearGradient id="paint0_linear_8_555" x1="543.036" y1="-200.81" x2="349.121" y2="167.62"
                                        gradientUnits="userSpaceOnUse">
                            <stop stop-color="#47BCFC"/>
                            <stop offset="1" stop-color="#47BCFC" stop-opacity="0"/>
                        </linearGradient>
                        <linearGradient id="paint1_linear_8_555" x1="412.416" y1="-38.6084" x2="230.451" y2="388.037"
                                        gradientUnits="userSpaceOnUse">
                            <stop stop-color="#47BCFC"/>
                            <stop offset="1" stop-color="#47BCFC" stop-opacity="0"/>
                        </linearGradient>
                        <linearGradient id="paint2_linear_8_555" x1="294.711" y1="313.114" x2="340.522" y2="130.185"
                                        gradientUnits="userSpaceOnUse">
                            <stop stop-color="white"/>
                            <stop offset="1" stop-color="white" stop-opacity="0"/>
                        </linearGradient>
                        <linearGradient id="paint3_linear_8_555" x1="299.34" y1="291.098" x2="341.501" y2="122.808"
                                        gradientUnits="userSpaceOnUse">
                            <stop stop-color="white"/>
                            <stop offset="1" stop-color="white" stop-opacity="0"/>
                        </linearGradient>
                        <linearGradient id="paint4_linear_8_555" x1="305.557" y1="270.391" x2="343.278" y2="119.875"
                                        gradientUnits="userSpaceOnUse">
                            <stop stop-color="white"/>
                            <stop offset="1" stop-color="white" stop-opacity="0"/>
                        </linearGradient>
            ...
            <div className="small-planet">
                <svg width="343" height="184" viewBox="0 0 343 184" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path
                        ...
                        stroke="url(#paint0_linear_8_562)" stroke-width="0.720133"/>
                    <path
                        ...
                        stroke="url(#paint1_linear_8_562)" stroke-width="0.720133"/>
                    <ellipse cx="77.3947" cy="77.3629" rx="77.3947" ry="77.3629"
                             transform="matrix(0.994355 -0.1061 0.106257 0.994339 84.8849 30.1504)"
                             fill="url(#paint2_linear_8_562)" fill-opacity="0.37"/>
                    <path
                        ...
                        stroke="url(#paint3_linear_8_562)" stroke-opacity="0.54"/>
                    <defs>
                        <linearGradient id="paint0_linear_8_562" x1="178.103" y1="147.278" x2="162.124" y2="52.777"
                                        gradientUnits="userSpaceOnUse">
                            <stop stop-color="white"/>
                            <stop offset="1" stop-color="white" stop-opacity="0"/>
                        </linearGradient>
                        <linearGradient id="paint1_linear_8_562" x1="171.677" y1="133.814" x2="157.472" y2="49.933"
                                        gradientUnits="userSpaceOnUse">
                            <stop stop-color="white"/>
                            <stop offset="1" stop-color="white" stop-opacity="0"/>
                        </linearGradient>
                        <linearGradient id="paint2_linear_8_562" x1="126.125" y1="-85.9588" x2="74.5679" y2="114.622"
                                        gradientUnits="userSpaceOnUse">
                            <stop stop-color="white"/>
                            <stop offset="1" stop-color="white" stop-opacity="0"/>
                        </linearGradient>
                        <linearGradient id="paint3_linear_8_562" x1="169.625" y1="13.7251" x2="137.766" y2="128.553"
                                        gradientUnits="userSpaceOnUse">
                            <stop stop-color="white"/>
                            <stop offset="1" stop-color="white" stop-opacity="0"/>
                        </linearGradient>
